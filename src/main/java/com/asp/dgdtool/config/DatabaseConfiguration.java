package com.asp.dgdtool.config;

import com.asp.dgdtool.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.asp.dgdtool.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.asp.dgdtool.repository.search")
