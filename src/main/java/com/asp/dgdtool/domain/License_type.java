...
@Document(indexName = "license_type")
public class License_type implements Serializable {
    ...
    @NotNull
    @Size(max = 200)
    @Column(name = "license_type_name", length = 200, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        License_type license_type = (License_type) o;

        if ( ! Objects.equals(id, license_type.id)) return false;
