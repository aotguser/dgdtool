...
@Document(indexName = "package_type")
public class Package_type implements Serializable {
    ...
    @NotNull
    @Size(max = 200)
    @Column(name = "package_type_name", length = 200, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        Package_type package_type = (Package_type) o;

        if ( ! Objects.equals(id, package_type.id)) return false;
