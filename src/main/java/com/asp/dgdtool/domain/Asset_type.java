...
public class Asset_type implements Serializable {
    ...
    @NotNull
    @Size(max = 200)
    @Column(name = "asset_type_name", length = 200, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        Asset_type asset_type = (Asset_type) o;

        if ( ! Objects.equals(id, asset_type.id)) return false;
