...
public class Statuses implements Serializable {
    ...
    private Integer status_type_id;
    ...
    public Integer getStatus_type_id() {
        return status_type_id;
    }

    public void setStatus_type_id(Integer status_type_id) {
    ...
    public boolean equals(Object o) {
        ...
        if ( ! Objects.equals(id, statuses.id)) return false;
