...
@Document(indexName = "server_type")
public class Server_type implements Serializable {
    ...
    @NotNull
    @Size(max = 200)
    @Column(name = "server_type_name", length = 200, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        Server_type server_type = (Server_type) o;

        if ( ! Objects.equals(id, server_type.id)) return false;
