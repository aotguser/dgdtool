...
@Document(indexName = "feedback_type")
public class Feedback_type implements Serializable {
    ...
    @NotNull
    @Size(max = 200)
    @Column(name = "feedback_type_name", length = 200, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        Feedback_type feedback_type = (Feedback_type) o;

        if ( ! Objects.equals(id, feedback_type.id)) return false;
    ...
    public String toString() {
        return "Feedback_type{" +
            "id=" + id +
            ", feedback_type_name='" + feedback_type_name + "'" +
