...
@Document(indexName = "field_type")
public class Field_type implements Serializable {
    ...
    @NotNull
    @Size(max = 200)
    @Column(name = "field_type_name", length = 200, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        Field_type field_type = (Field_type) o;

        if ( ! Objects.equals(id, field_type.id)) return false;
