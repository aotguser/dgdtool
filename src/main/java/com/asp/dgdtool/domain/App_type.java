...
@Document(indexName = "app_type")
public class App_type implements Serializable {
    ...
    @NotNull
    @Size(max = 200)
    @Column(name = "app_type_name", length = 200, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        App_type app_type = (App_type) o;

        if ( ! Objects.equals(id, app_type.id)) return false;
